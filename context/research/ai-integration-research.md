...
Investigate best practices for integrating the OpenAI "gpt-5-nano" model into a .NET API application for the following features:
...
- .NET API + @src/actions/\*.ts for action patterns
- .NET rate limiting and pro user feature for gating patterns
