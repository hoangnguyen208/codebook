import { Code2, Sparkles, Terminal, FileText, File, FileImage, Link2, FolderOpen, Layers3 } from "lucide-react";
    ...
    <main className="mx-auto flex min-h-screen w-full max-w-3xl flex-col gap-6 px-4 py-8">
      <section className="rounded-3xl border border-border/70 bg-card p-8 shadow-sm">
        <div className="flex items-center gap-4">
          <UserAvatar nameOrEmail={name} imageUrl={session?.user?.image} className="size-16 shrink-0" textClassName="text-xl" />
